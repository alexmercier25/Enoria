...
function Widget:SetBaseGuiProperties(element)
	...
	self:SetPropertyFromOptionsOrTheme(element, "AnchorPoint", options)
	self:SetPropertyFromOptionsOrTheme(element, "AutomaticSize", options)
	self:SetPropertyFromOptionsOrTheme(element, "BackgroundColor3", options)
	self:SetPropertyFromOptionsOrTheme(element, "BackgroundTransparency", options)
	self:SetPropertyFromOptionsOrTheme(element, "BorderColor3", options)
	self:SetPropertyFromOptionsOrTheme(element, "BorderMode", options)
	self:SetPropertyFromOptionsOrTheme(element, "BorderSizePixel", options)
	self:SetPropertyFromOptionsOrTheme(element, "LayoutOrder", options)
	self:SetPropertyFromOptionsOrTheme(element, "NextSelectionDown", options)
	self:SetPropertyFromOptionsOrTheme(element, "NextSelectionLeft", options)
	self:SetPropertyFromOptionsOrTheme(element, "NextSelectionRight", options)
	self:SetPropertyFromOptionsOrTheme(element, "NextSelectionUp", options)
	self:SetPropertyFromOptionsOrTheme(element, "Selectable", options)
	self:SetPropertyFromOptionsOrTheme(element, "Size", options)
	self:SetPropertyFromOptionsOrTheme(element, "SizeConstraint", options)
	self:SetPropertyFromOptionsOrTheme(element, "ClipsDescendants", options)
	self:SetPropertyFromOptionsOrTheme(element, "Position", options)
	self:SetPropertyFromOptionsOrTheme(element, "Rotation", options)
	self:SetPropertyFromOptionsOrTheme(element, "SelectionImageObject", options)
	self:SetPropertyFromOptionsOrTheme(element, "ZIndex", options)
	self:SetPropertyFromOptionsOrTheme(element, "AutoLocalize", options)
	self:SetPropertyFromOptionsOrTheme(element, "RootLocalizationTable", options)
	self:SetPropertyFromOptionsOrTheme(element, "Archivable", options)
